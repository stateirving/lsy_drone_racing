...
The online competition takes place every semester for the students of the "Autonomous Drone Racing" class at TUM. Students compete against each other on [level 2](overview.md).
...
1. Fork the lsy_drone_racing repository to your own GitHub account.

2. Add the provided DISPATCH_TOKEN to your fork's secrets under Settings > Secrets and variables > Actions
