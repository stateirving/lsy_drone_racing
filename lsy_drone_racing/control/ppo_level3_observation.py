...
LOCAL_OBSTACLE_FRAME_OBSERVATION_LAYOUT = (
    "level3_target_gate_nearest_frame_2obs_local_history_v6"
)
SPHERICAL_GATE_OBSTACLE_POLAR_V9_OBSERVATION_LAYOUT = (
    "level3_spherical_gate_obstacle_polar_nodetect_gravity_2obs_local_history_v9"
)
SPHERICAL_GATE_OBSTACLE_POLAR_OBSERVATION_LAYOUT = (
    "level3_spherical_target_next_nearest2_obstacle_polar_nodetect_gravity_2obs_local_history_v11"
)
SPHERICAL_GATE_OBS_COUNT_BY_LAYOUT = {
    SPHERICAL_GATE_OBSTACLE_POLAR_V9_OBSERVATION_LAYOUT: 2,
    SPHERICAL_GATE_OBSTACLE_POLAR_OBSERVATION_LAYOUT: 4,
}
